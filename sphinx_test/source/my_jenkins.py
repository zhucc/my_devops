...
api_tokens =
    {"http://10.140.19.16:8080/": "7420b9fd494ed2f44cf5b7b2db9a3fe6",
...
class MY_JK(JK):
    ...
    def check_all_jobs(self):
        ...
        all_red_job_url = [job['url']
                           for job in all_jobs if job['color'] == 'red']
    ...
    def _get_jobs_by_view(self, view_name):
        try:
            view_jobs = [i[u"fullname"]
                         for i in self._get_view_jobs(view_name)]
            return view_jobs
        except Exception as e:
